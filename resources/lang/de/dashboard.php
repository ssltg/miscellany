...
return [
    ...
    'title'             => 'Dashboard',
    'welcome'           => [
        'body'      => "Willkommen bei " . config('app.name') . "! Deine erste Kampagne wurde erstellt und wir haben zur Inspiration ein paar Beispielobjekte mit angelegt (kannst du jederzeit löschen).
