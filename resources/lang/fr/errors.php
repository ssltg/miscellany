...
return [
    ...
    '503'       => [
        'body'  => [
            '1' => config('app.name') . ' est actuellement en maintenance, ce qui d\'habitude signifie qu\'une mise à jour est en cours!',
            '2' => 'Désolé pour le dérangement. Tout reviendra à la normale dans quelques minutes.',
        ],
        'title' => 'Maintenance',
    ],
    '503-form'  => [
        'body'  => 'Problème lors de le l\'enregistrement des données, ce qui est généralement causé par l\'un des deux scénarii suivant. Prière d\'ouvrir ' . config('app.name') . ' dans une :link. Si l\'application est en maintenance, il est préférable de sauvegarder les données dans une autre application et de réssayer lorsque ' . config('app.name') . ' est de retour. Si le message "Checking your browser" apparait, la sauvegarde peut être essayée à nouveau.',
        'link'  => 'nouvelle fenêtre',
        'title' => 'Erreure inattendue.',
    ],
    'footer'    => 'Si tu as besoin d\'aide, contactes-nous a hello@' . config('app.site_name') . ' ou sur le :discord.',
];
