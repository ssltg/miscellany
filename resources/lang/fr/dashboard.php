...
return [
    ...
    'welcome'           => [
        'body'      => "
Bienvenue sur " . config('app.name') . "! Ta première campagne a été créée et nous avons inclus quelques examples d'entités pour t'inspirer (tu peux les supprimer à tout moment).
