...
return [
    ...
    'title'             => 'Tablero de',
    'welcome'           => [
        'body'      => "¡Bienvenid@ a " . config('app.name') . "! Tu primera campaña ha sido creada y hemos incluido un par de entidades de ejemplo como inspiración (puedes borrarlas cuando quieras).
