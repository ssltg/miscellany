...
return [
    ...
    '503'       => [
        'body'  => [
            '1' => config('app.name') . ' è attualmente in manutenzione che normalmente significa che un c\'è aggiornamento in corso!',
            '2' => 'Ci dispiace per l\'inconveniente. Tutto tornerà alla normalità in pochi minuti.',
        ],
        'title' => 'Manutenzione',
    ],
    '503-form'  => [
        'body'  => 'Non possiamo salvare i tuoi dati correttamente, chè è normalmente causato da uno dei seguenti due fattori. Per favore apri ' . config('app.name') . ' in una :link se l\'app è in manutenzione, salva cortesemente i tuoi dati da qualche altra parte finché l\'app non è nuovamente utilizzabile e riprova.Se vieni avvisato da un "Controlla il tuo browser" può provare a salvare nuovamente.',
        'link'  => 'nuova finestra',
        'title' => 'È successo qualcosa di inaspettato.',
    ],
    'footer'    => 'Se necessiti di ulteriore assistenza per favore contattaci a hello@' . config('app.site_name') . ' oppure su :discord',
];
